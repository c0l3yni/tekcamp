...
public class AddButcherBlock {
  public AddButcherBlock() {
    ...
    while (continueFlag) {
      ...
      System.out.println("Enby of All: Pick an item to customize or press 25 to add Butch-er Block to order");
      ...
      switch (newInput) {
        ...
        case 25:
          continueFlag = false;
          System.out.println("__________________________________________________");          break;
      }
    }
    createReceipt(combo);
